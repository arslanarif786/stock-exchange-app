    ...
    <template #item="{ element, index }">
      <div class="list-group-item">
        ...
        <div
          ...
          @mouseenter="hoverEffectTrue(index)"
          @mouseleave="hoverEffectFalse(index)">
          <div
            v-if="index == hoverItem"
            class="absolute flex justify-end items-center w-11/12">
            <div
              ...
              @click="alphabet_B(index, element)">
              B
            ...
            <div
              ...
              style="padding-top: 1px"
              :class="!hoverEffect ? 'hidden' : 'block'"
              @click="alphabet_S(index, element)">
              S
              <q-tooltip anchor="top middle" self="bottom middle" :offset="[3, 3]" class="bg-black font-semibold txt13">
                Sell (S)
              </q-tooltip>
            ...
            <div
              ...
              style="padding-top: 1px"
              :class="!hoverEffect ? 'hidden' : 'block'"
              @click="formatAlign(index, element)"
              >
            ...
            <div
              ...
              style="padding-top: 1px"
              :class="!hoverEffect ? 'hidden' : 'block'"
              @click="movingItem(index, element)"
              >
            ...
            <div
              ...
              style="padding-top: 1px"
              :class="!hoverEffect ? 'hidden' : 'block'"
              @click="deleteItem(index, element)">
...
const filteredList = computed(() => {
  ...
  return lists.value.filter((row) =>
    row.title.toLowerCase().includes(props.searchQuery)
  )
})
